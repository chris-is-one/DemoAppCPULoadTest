...
class DemoActivity : Activity(), DemoActivityListener {
    ...
    private fun setupIronSourceSdk(){
        ...
        val levelPlayInitListener = DemoLevelPlayInitListener(this)
        ...
        val initReq = LevelPlayInitRequest.Builder(APP_KEY)
            ...
            .build()
        LevelPlay.init(this, initReq, levelPlayInitListener)

        val initReq2 = LevelPlayInitRequest.Builder(APP_KEY)
            .withLegacyAdFormats(listOf(LevelPlay.AdFormat.INTERSTITIAL,
                LevelPlay.AdFormat.NATIVE_AD))
            .build()
        LevelPlay.init(this, initReq2, levelPlayInitListener)
//        IronSource.init(this, APP_KEY, DemoInitializationListener(this))
    ...
    fun jumpToSettingsActivity(view: View) {
...
//        setBannerViewVisibility(View.GONE)
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            R.id.settings -> {
                val intent = Intent().setAction("com.ironsource.action.Settings")
                startActivity(intent)
                true
            }
